...
namespace MaktabNews.Infrastructure.EfCore.Migrations
{
    ...
    [Migration("20240316191847_addpropertycreateatnews")]
    partial class addpropertycreateatnews
    {
            ...
            modelBuilder.Entity("MaktabNew.Domain.Core.Entities.News", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreateAt = new DateTime(2024, 3, 16, 22, 48, 47, 208, DateTimeKind.Local).AddTicks(3566),
