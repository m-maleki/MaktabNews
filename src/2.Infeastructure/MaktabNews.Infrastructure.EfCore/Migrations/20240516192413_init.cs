...
namespace MaktabNews.Infrastructure.EfCore.Migrations
{
    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Reporters",
                columns: new[] { "Id", "AboutMe", "FullName", "ImageAddress" },
                values: new object[,]
                {
                    { 2, null, "علی محمدی", "~/assets/img/author/1.jpg" },
                    { 3, null, "سحر رمضانی", "~/assets/img/author/2.jpg" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_ReporterId",
                table: "AspNetUsers",
                column: "ReporterId");
